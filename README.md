...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-term-8e0f
```

A live public deployment of this template is available at [https://broad-term-8e0f.templates.workers.dev](https://broad-term-8e0f.templates.workers.dev)
